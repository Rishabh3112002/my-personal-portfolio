    ...
    <div id="about" className="about-main">
      ...
      <div className="about">
        ...
        <p className="about-text">
          ...
          Let's create something awesome together!<br></br><br></br>Resume: <a className="resume" href="https://drive.google.com/file/d/1bXl0kmgfSEJnVREo_97W6ScKWJFs-jgD/view?usp=drive_link" target="_blank">Click here!</a>
        </p>
      </div>
    </div>
  );
